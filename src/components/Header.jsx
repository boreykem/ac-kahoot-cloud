                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-[9px] text-purple-200/80 leading-none truncate max-w-[90px] sm:max-w-[120px]">
                      {currentUser.license === 'VIP_SCHOOL' || currentUser.license === 'vip_unlimited' ? '🏫 VIP School' : 
                       currentUser.license === 'PRO_LIFETIME' || currentUser.license === 'pro_lifetime' ? '👑 Pro Lifetime' : 
                       currentUser.license === 'pro_annual' ? '⭐ Pro Account' : 
                       currentUser.license === 'pro_monthly' ? '⏳ Pro Monthly' : 
                       currentUser.license === 'founder_unlimited' ? '👑 Founder' : 
                       currentUser.license === 'pro' ? '⭐ Pro Account' : 
                       'គណនី Free'}
                    </p>
                  </div>
                </button>
