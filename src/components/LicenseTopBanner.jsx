...
export default function LicenseTopBanner({ 
  ...
  return (
    <div className="banner-flowing border-b border-white/20 text-white px-2.5 py-1.5 sm:py-2 text-xs sm:text-sm font-khmer shadow-md relative z-50 overflow-hidden">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 relative z-10">
        ...
        <div className="flex-1 text-center font-medium flex items-center justify-center flex-wrap gap-x-1.5 gap-y-0.5 px-1">
          <span className="text-white drop-shadow-md leading-tight sm:leading-snug flex items-center gap-1 font-bold text-[11px] sm:text-xs md:text-sm">
            <span className="inline-block text-yellow-300">⚡</span>
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button
            ...
            className="px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-lg sm:rounded-xl bg-white hover:bg-yellow-300 text-purple-950 font-black text-[11px] sm:text-xs shadow-md transition-all hover:scale-105 active:scale-95 flex items-center gap-1 shrink-0 whitespace-nowrap"
          >
            <span>{btnText}</span>
