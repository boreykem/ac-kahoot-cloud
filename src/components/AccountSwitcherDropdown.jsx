...
export default function AccountSwitcherDropdown({
  ...
  return (
    <div 
      ref={dropdownRef}
      className="absolute right-0 top-full mt-2 w-80 sm:w-96 rounded-2xl bg-[#190432] border border-purple-400/40 shadow-2xl shadow-black/80 z-50 overflow-hidden font-khmer animate-scale-in text-white"
    >
      {/* Header */}
