  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-8 space-y-8 font-khmer">
      ...
      <div className="relative rounded-3xl overflow-hidden glass-panel p-6 sm:p-10 border border-purple-500/20 bg-gradient-to-r from-purple-900/60 via-indigo-900/40 to-black/60 shadow-2xl">
        ...
        {/* Decorative Graphic Elements - Smooth Rotating & Floating */}
        <div className="absolute right-4 -bottom-10 w-80 h-80 rounded-full bg-purple-500/20 blur-3xl pointer-events-none" />
        <div className="absolute right-8 sm:right-16 top-6 sm:top-8 pointer-events-none hidden md:block animate-float-gentle">
          <div className="grid grid-cols-2 gap-3.5 animate-spin-slow opacity-60 hover:opacity-100 transition-opacity">
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-3xl bg-gradient-to-br from-[#ff3b56] to-[#b30e28] flex items-center justify-center text-3xl sm:text-4xl text-white font-black shadow-xl shadow-red-950/60 border border-white/20">
              ▲
            </div>
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-3xl bg-gradient-to-br from-[#2a84f3] to-[#0d4ea0] flex items-center justify-center text-3xl sm:text-4xl text-white font-black shadow-xl shadow-blue-950/60 border border-white/20">
              ◆
            </div>
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-3xl bg-gradient-to-br from-[#ffb703] to-[#c48200] flex items-center justify-center text-3xl sm:text-4xl text-white font-black shadow-xl shadow-amber-950/60 border border-white/20">
              ●
            </div>
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-3xl bg-gradient-to-br from-[#38b000] to-[#1b6b00] flex items-center justify-center text-3xl sm:text-4xl text-white font-black shadow-xl shadow-green-950/60 border border-white/20">
              ■
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-44 w-full overflow-hidden bg-purple-950/50">
                  ...
                  <div className="absolute bottom-3 left-3 bg-black/70 backdrop-blur-md px-3 py-1 rounded-full text-xs font-bold text-white flex items-center gap-1.5 border border-white/20">
                  ...
                  {/* Level Tag */}
                  <div className="absolute top-3 right-3 bg-purple-600/90 backdrop-blur-md px-3 py-1 rounded-full text-[11px] font-bold text-white shadow-md uppercase">
