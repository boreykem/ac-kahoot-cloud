...
function generateCryptographicKey(hwid, planType = 'PRO_LIFETIME', durationDays = 0) {
  ...
  if (durationDays > 0) {
    ...
    // Base36 representation of expiry epoch timestamp
 ...
 */
function verifyCryptographicKey(licenseKey, targetHwid = null) {
 ...
 */
function saveActiveLicense(licenseKey, licensedTo = '') {
