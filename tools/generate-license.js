 ...
 * Usage: node generate-license.js [HWID] [PLAN: pro_lifetime|pro_annual|pro_monthly|vip] [DAYS]
 */

const { generateCryptographicKey, verifyCryptographicKey } = require('../server/security/licensing');
...
========================================================================
  ...
  👉 របៀបប្រើ (Usage):
     node tools/generate-license.js <HWID> [PLAN] [DURATION_DAYS]

  👉 ឧទាហរណ៍ (Examples):
     1. Pro Lifetime:
        node tools/generate-license.js ACK-HWID-4B82-99FA-10CD PRO_LIFETIME

     2. Pro 1 Year (365 Days):
        node tools/generate-license.js ACK-HWID-4B82-99FA-10CD PRO_ANNUAL 365

     3. Pro 1 Month (30 Days):
        node tools/generate-license.js ACK-HWID-4B82-99FA-10CD PRO_MONTHLY 30

     4. VIP School Edition:
        node tools/generate-license.js ACK-HWID-4B82-99FA-10CD VIP_SCHOOL
